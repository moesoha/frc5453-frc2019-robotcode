...
OI::OI() {
	...
	(new frc::JoystickButton(joystickOperator2.get(), 7))->WhileHeld(new HamRaisingCommand());
	(new frc::JoystickButton(joystickOperator2.get(), 8))->WhileHeld(new HamLyingCommand());
	(new frc::JoystickButton(joystickOperator2.get(), 9))->WhileHeld(new BackHamRaisingCommand());
	(new frc::JoystickButton(joystickOperator2.get(), 10))->WhileHeld(new BackHamLyingCommand());
